function myMove(container, elem) {
    ...
    if (pausa == false) {
        ...
        if (botiquines.length > 0 || armas.length > 0 || municiones.length > 0 || listaBiohazards.length > 0) {
        ...
        if (inmunidadVeneno == false) {

            for (let i = 0; i < listaBiohazards.length; i++) {
                var limiteItemXizda = document.getElementById(listaBiohazards[i].nombre).getBoundingClientRect().left -
                    document.getElementById("container").getBoundingClientRect().left;

                var limiteItemXdcha = document.getElementById(listaBiohazards[i].nombre).getBoundingClientRect().right -
                    document.getElementById("container").getBoundingClientRect().left;

                var limiteItemYtop = document.getElementById(listaBiohazards[i].nombre).getBoundingClientRect().top -
                    document.getElementById("container").getBoundingClientRect().top;

                var limiteItemYbot = document.getElementById(listaBiohazards[i].nombre).getBoundingClientRect().bottom -
                    document.getElementById("container").getBoundingClientRect().top;
                ...
                if ((xPersonajeHitbox >= limiteItemXizda && xPersonajeHitbox <= limiteItemXdcha) &&
                    ...
                    break;//Evitamos asi que se acumulen venenos en el suelo (doble daño, triple etc) y reducimos comprobaciones
                }
            }
        }
